...
/*
L'intestazione limits.h determina varie proprietà dei vari tipi di variabili. 
Le macro definite in questa intestazione limitano i valori di vari tipi di variabili come char, int e long.
Questi limiti specificano che una variabile non può memorizzare alcun valore oltre questi limiti, 
ad esempio un carattere senza segno può memorizzare fino a un valore massimo di 255. 
